export default function Auth({ handleSubmit, children }: any) {
    return (
        <div className="flex md:grid md:grid-cols-4 lg:grid-cols-5 w-full h-screen">
            ...
            <form className="flex-1 md:col-span-2 flex" onSubmit={handleSubmit}>
                <div className="my-auto mx-5">
                    ...
                    <p className="my-3 text-sm font-medium text-gray-600">Sign in to your account and continue your journey towards improved productivity.</p>
